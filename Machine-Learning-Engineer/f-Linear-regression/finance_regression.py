...
reg1 = LinearRegression().fit(feature_train, target_train)
reg2 = LinearRegression().fit(feature_test, target_test)
...
try:
    ...
    plt.plot( feature_test, reg2.predict(feature_test), color="r")
except NameError:
    pass
