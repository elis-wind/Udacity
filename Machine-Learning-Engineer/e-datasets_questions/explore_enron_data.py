...
print("The CEO of Enron during much of the time fraud was ongoing: Jeffrey Skilling")
...
print("Of these three individuals, {} took home the most money ({})".format(most_money[1], most_money[0]))
